...
\\[
  \delta\_l^{(l)} = { \sum\_k \delta\_k^{(l+1)} w\_{kj}^{(l+1)} + \beta \left( - \frac{\rho}{\hat{\rho}\_j} + \frac{1 - \rho}{1 - \hat{\rho}\_j} \right) } f'(u\_j^{(l)})
\\]
...
\\[
  \sum\_k \delta\_k^{(l+1)} w\_{kj}^{(l+1)}
\\]

\\[
  \beta \left( - \frac{\rho}{\hat{\rho}\_j} + \frac{1 - \rho}{1 - \hat{\rho}\_j} \right)
\\]
